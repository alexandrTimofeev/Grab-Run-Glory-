...
namespace PlatformCharacterController
{
    public class TeleportToNextScene : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            _GoLevel.gameObject.SetActive(false);
            _GoLevel.onClick.AddListener(LoadNextLevel);
        }
        ...
        private void OnTriggerEnter(Collider other)
        {
            ...
            {
                _IsEntered = true;
                DisplayMessage("Press [Play] to Enter Level");
                ...
                if (DiamondText) {
                    ...
                    _GoLevel.gameObject.SetActive(true);
        ...
        public void LoadNextLevel()
        {
            ...
            Debug.Log("Loading scene: " + scenename + " from object: " + gameObject.name);
        }
